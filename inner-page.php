			...
			<div class="container">
				<div class="breadcrumb">
	   			<ul>
	   				...
	   				<li><a href="/">Поклейка обоев</a></li>
	   				<li>Поклейка бумажных обоев</li>
	   			</ul>
	   		</div>
				<header class="section-header">
	            <h1 class="section-title">Поклейка бумажных обоев</h1>
	         </header>
				<article class="content txt-block">
					<div class="article-slider">
	                  ...
	                  <div class="article-nav-item next-slide"><svg class="chevron-slider"><use xlink:href="#chevron-slider"></use></svg></div>
	               </div>
					</div>
