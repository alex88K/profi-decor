		...
		<div class="content-wrap">
			<div class="container">
				...
				<article class="content txt-block">
					<div class="row">
						<div class="catalog-item col-md-4 col-sm-4 col-xs-12">
							<a class="catalog-link" data-toggle="collapse" href="#catalog-sub-1" aria-expanded="false" aria-controls="catalog-sub-1">
								<img src="pic/catalog/img1.jpg" alt="Поклейка обоев">
								<div class="catalog-title">Поклейка обоев</div>
							</a>
						</div>
						<div class="catalog-item col-md-4 col-sm-4 col-xs-12">
							<a class="catalog-link" data-toggle="collapse" href="#catalog-sub-2" aria-expanded="false" aria-controls="catalog-sub-2">
								<img src="pic/catalog/img2.jpg" alt="Декоративные работы">
								<div class="catalog-title">Декоративные работы</div>
							</a>
						</div>
						<div class="catalog-item col-md-4 col-sm-4 col-xs-12">
							<a class="catalog-link" data-toggle="collapse" href="#catalog-sub-3" aria-expanded="false" aria-controls="catalog-sub-3">
								<img src="pic/catalog/img3.jpg" alt="Услуги">
								<div class="catalog-title">Услуги</div>
							</a>
						</div>
					</div>
					<div class="tab-content">
						<div id="catalog-sub-1" class="collapse">
						...
						<div id="catalog-sub-2" class="collapse">
							<div class="catalog-sublist">
								<ul>
									<li><a href="/">Поклейка бумажных обоев</a></li>
									<li><a href="/">Поклейка флизелиновых обоев</a></li>
						...
						<div id="catalog-sub-3" class="collapse">
							<div class="catalog-sublist">
								<ul>
									<li><a href="/">Поклейка бумажных обоев</a></li>
									<li><a href="/">Поклейка флизелиновых обоев</a></li>
